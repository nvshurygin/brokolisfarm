(function () {
  ...
  function initNativeTildaCart() {
    ...
    return Promise.resolve(window.tcart__init(recordId))
      .catch(function () {
        return false;
      })
      .then(function () {
  ...
  function ensureTildaProductHeader(templates) {
    ...
    var headerMount = headerRoot.querySelector("[data-bf-product-header-mount]");
    if (!headerMount) {
      headerMount = document.createElement("div");
      headerMount.setAttribute("data-bf-product-header-mount", "true");
    ...
    headerRoot.classList.add("bf-tilda-product-header");
  }
